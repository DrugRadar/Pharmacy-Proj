...
<div class="card align-self-center bg-gradient-dark">
    <img src="{{$doctor->getFirstMediaUrl('avatar_image', 'thumb') ? $doctor->getFirstMediaUrl('avatar_image', 'thumb') : asset('assets/gifs/user.png')}}"
        alt="profile picture" class="profile__picture">
    <a href="{{route('doctor.profile.edit', Auth::user()->userable_id)}}" class="w-25 align-self-end mt-1 me-1"
    ...
    <div class="contact row">
        ...
        <div class="col-6">
            <h5>Member since</h5>
            <p>{{$doctor->created_at->diffForHumans()}}</p>
        </div>
    </div>
</div>
