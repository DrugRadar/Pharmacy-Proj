...
<div>
    ...
    <form method="POST" action="{{route('doctor.update',$doctor->id)}}" enctype="multipart/form-data">
        ...
        <div class="mb-3 mt-3">
            ...
            <input type="text" name="name" class="form-control w-50" id="exampleFormControlInput1" placeholder="Doctor Name" value="{{ old('name', $doctor->name) }}">
            @error('name')
        ...
        <div class="mb-3">
            ...
            <input type="text" name="email" class="form-control w-50" id="exampleFormControlInput1" placeholder="Doctor Email"  value="{{ old('email', $doctor->email) }}">
            @error('email')
                <p class="text-danger mt-1">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="password" class="form-control w-50" id="exampleFormControlInput1" placeholder="Doctor Password" value="{{ old('password', $doctor->password) }}">
            @error('password')
                <p class="text-danger mt-1">{{ $message }}</p>
            @enderror
        </div>
