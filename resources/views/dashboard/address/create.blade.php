...
<div>
    <form method="POST" action="{{route('address.store')}}" enctype="multipart/form-data">
        ...
        <div class="mb-3 mt-3">
            ...
            <input type="text" name="street_name" class="form-control w-50" id="exampleFormControlInput1" placeholder="Address street Name" value="{{old('street_name')}}">
            @error('street_name')
                <p class="text-danger mt-1">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="building_number" class="form-control w-50" id="exampleFormControlInput1" placeholder="Address building number" value="{{old('building_number')}}">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="floor_number" class="form-control w-50" id="exampleFormControlInput1" placeholder="Address floor number" value="{{old('floor_number')}}">
            @error('floor_number')
                <p class="text-danger mt-1">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="flat_number" class="form-control w-50" id="exampleFormControlInput1" placeholder="Address flat number" value="{{old('flat_number')}}">
            @error('flat_number')
                <p class="text-danger mt-1">{{ $message }}</p>
            @enderror
        </div>
