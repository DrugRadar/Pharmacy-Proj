...
<div class="card align-self-center bg-gradient-dark">
        ...
        <a href="{{route('pharmacy.edit', Auth::user()->userable_id)}}" class="w-25 align-self-end mt-1 me-1" style="border:none; background:transparent text-decorations:none; color:inherit;  position:relative; top: 28px; right: 128px;"><i class='bx bx-edit' style="font-size: 33px;"></i></a>
        <div class="text">
            <h3>Doctor Name</h3>
            <p>{{$pharmacy->name}}</p>
            <hr>
