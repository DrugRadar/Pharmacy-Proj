            ...
            <div class="card blurred-box">
                ...
                <div class="card-body d-flex justify-content-center align-items-center flex-column">
                    ...
                    @endif
                     ...
                     @if($message =='Order canceled')
                        {{ $message }}
                     <p class="card-text">We're sorry to hear that you've canceled your order. </br>
                      If you have any questions or concerns, please don't hesitate to contact us.</p>
                      <i class="fas fa-sad-tear fa-lg" style="color: #4a968d;"></i>
                      @else
                      <i class="fa fa-ban fa-lg"style="color: #4a968d;" aria-hidden="true"></i>
