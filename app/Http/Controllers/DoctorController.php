        ...
        if ($request->ajax()) {
            return DataTables::of($data)
                ...
                ->addColumn('action', function($row) {
                    $actionBtn = '<a href="/doctor/'.$row->id.'/edit" class="edit btn btn-success btn-sm"><i class=\'bx bx-edit\'></i></a> <button type="button" class="delete btn btn-danger" data-bs-toggle="modal"
